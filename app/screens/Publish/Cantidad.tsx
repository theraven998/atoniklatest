...
const Cantidad: React.FC = () => {
  const { Nombre, Fecha, Price, time, city , barrio, Descripcion, longitude, latitude } = useLocalSearchParams();
  ...
  const handleRegister = () => {
    ...
    router.push({
      pathname: "/screens/Publish/MinEdad",
      params: { Nombre, Fecha, time, Cantidad, Price, barrio, city, latitude, longitude, Descripcion },
    });
  };
  const handlePress = () => {
    if (Cantidad === "") {
      showModalAlert("Por favor, ingresa cantidad de tickets para tu evento.");
    } else {
      handleRegister();
    }
  };
      ...
      <View style={styles.overlay}>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.cajaPregunta}>
            <Text style={styles.buttontext}>Cual es la cantidad de</Text>
            <Text style={styles.textbold}>boletas?</Text>
          </View>
