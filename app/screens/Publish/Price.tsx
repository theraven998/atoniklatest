...
const PriceEvent: React.FC = () => {
  const { Nombre, Fecha, time } = useLocalSearchParams();
  ...
  const handleRegister = () => {
    router.push({
      pathname: "/screens/Publish/Ubicacion",
      params: { Nombre, Fecha, time, Price },
    });
  };
  const handlePress = () => {
    if (Price === "") {
      ...
      <View style={styles.overlay}>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.cajaPregunta}>
            <Text style={styles.buttontext}>Cual es el precio de la</Text>
            <Text style={styles.textbold}>boleta?</Text>
          </View>
